...
HTML.query('body').appendChild(new KeyboardLayout([
    [
    ...
    [
        { width: 59, char: '' }, { width: 32, char: 'A', func: 'Last Step', class: 'group-func' },
        ...
        { width: 32, char: 'K', func: 'Back\nTap', class: 'group-other' }, { width: 32, char: 'L', func: 'Fwd\nBank 1', class: 'group-other' },
        { width: 32, char: ';', func: 'Available\nBank 2', class: 'group-other' }, { width: 32, char: '\'', func: 'Cycle\nGuide', class: 'group-other' },
        { width: 59, char: 'return', class: 'align-bottom align-right group-meta', func: 'Enter' }
    ],
    [
        { width: 77, char: 'shift', class: 'align-bottom group-meta', func: 'Shift' }, { width: 32, char: 'Z' }, { width: 32, char: 'X' }, { width: 32, char: 'C' },
        { width: 32, char: 'V' }, { width: 32, char: 'B' }, { width: 32, char: 'N' }, { width: 32, char: 'M' },
        { width: 32, char: ',' }, { width: 32, char: '.' }, { width: 32, char: '/' },
        { width: 77, char: 'shift', class: 'align-bottom align-right group-meta', func: 'Shift' }
    ],
    [
        { width: 32, char: '' }, { width: 32, char: '' }, { width: 32, char: '' }, { width: 41, char: '' },
        { width: 176, char: '', func: 'Stop/Cont', class: 'group-meta' }, { width: 41, char: '' }, { width: 32, char: '' }, { width: 32, char: '' },
