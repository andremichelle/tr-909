...
const waitForTransportState = (transport, expected) => ({
    start: (complete) => {
...
const waitForValue = (value, expected) => ({
    start: (complete) => {
...
export const startTutorial = (context) => {
    ...
    return new Lecture()
        ...
        .appendPause(2)
        .appendWords(`Let's enter some steps. The selected instrument is currently the basedrum...`)
        .appendPause(1)
        .appendSentence(new Sentence()
